...
int main() {
    ...
    if (mode == "encrypt") {
        ...
        if(input_file_string == "default")
            input_file_string = "/home/stud/C++Projects/pract_4/text_2_1.txt";
        ...
        if(output_file_string == "default")
            output_file_string = "/home/stud/C++Projects/pract_4/text_2_2.txt";
        ...
        ofstream user_password_file("/home/stud/C++Projects/pract_4/passw.txt");
        StringSource(pass, true, new FileSink(user_password_file));
        ofstream key_file("/home/stud/C++Projects/pract_4/key.txt");
        ArraySource(key, sizeof(key), true, new FileSink(key_file));
        ofstream IV_file("/home/stud/C++Projects/pract_4/iv.txt");
        ...
        string user_pass;
        FileSource("/home/stud/C++Projects/pract_4/passw.txt", true, new StringSink(user_pass));
        if (pass != user_pass) {
        ...
        cin >> input_file_string;
        if(input_file_string == "default")
            input_file_string = "/home/stud/C++Projects/pract_4/text_2_2.txt";
        ifstream input_check(input_file_string);
        if(input_check.is_open() == 0) {
        ...
        cin >> output_file_string;
        if(output_file_string == "default")
            output_file_string = "/home/stud/C++Projects/pract_4/text_2_3.txt";
        ifstream output_check(output_file_string);
        if(output_check.is_open() == 0) {
        ...
        byte key[Tiger::DIGESTSIZE];
        FileSource("/home/stud/C++Projects/pract_4/key.txt", true, new ArraySink(key, sizeof(key)));
        byte IV[ AES::BLOCKSIZE ];
        FileSource("/home/stud/C++Projects/pract_4/iv.txt", true, new ArraySink(IV, sizeof(IV)));
